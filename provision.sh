...
install_nodes_bg() {
    (
        ...
        # nodes rely on.
        # ultralytics (YOLO) is required by Impact-Subpack's face/object
        # detectors but is not always pulled in by requirements.txt alone --
        # install it explicitly to avoid "ModuleNotFoundError: ultralytics"
        # at ComfyUI startup.
