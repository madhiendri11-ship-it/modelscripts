#!/bin/bash
# ============================================================
#  provision.sh — ComfyUI base model provisioner for RunPod
#  (models only — no LoRAs)
# ============================================================
...
if [ "$ZIMAGE" = "true" ]; then
    ...
    fetch_bg "z_image_bf16.safetensors" "$MODELS/unet/z_image_bf16.safetensors" \
        "https://huggingface.co/Comfy-Org/z_image_turbo/resolve/main/split_files/diffusion_models/z_image_bf16.safetensors" 7 \
